...
crypto:!1// true/false
},h=!0,l="[DecimalError] ",d=l+"Invalid argument: ",f=l+"Precision limit exceeded",p=l+"crypto unavailable",v="[object Decimal]",y=Math.floor,g=Math.pow,m=/^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i,w=/^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i,x=/^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i,b=/^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i,S=s.length-1,E=a.length-1,O={toStringTag:v};// Helper functions for Decimal.prototype (P) and/or Decimal methods, and their callers.
/*
...
for(;!t[0]&&t.length>1;)t.shift()}return function(r,o,s,a,c,u){var h,l,d,f,p,v,g,m,w,x,b,S,E,O,N,_,M,A,R,D,L=r.constructor,k=r.s==o.s?1:-1,P=r.d,C=o.d;// Either NaN, Infinity or 0?
...
for(u?(p=1,l=r.e-o.e):(u=1e7,p=7,l=y(r.e/p)-y(o.e/p)),R=C.length,M=P.length,x=(w=new L(k)).d=[],d=0;C[d]==(P[d]||0);d++);if(C[d]>(P[d]||0)&&l--,null==s?(O=s=L.precision,a=L.rounding):O=c?s+(r.e-o.e)+1:s,O<0)x.push(1),v=!0;else{// divisor < 1e7
if(// Convert precision in number of base 10 digits to base 1e7 digits.
O=O/p+2|0,d=0,1==R){// k is the carry.
for(f=0,C=C[0],O++;(d<M||f)&&O--;d++)N=f*u+(P[d]||0),x[d]=N/C|0,f=N%C|0;v=f||d<M;// divisor >= 1e7
}else{// Add zeros to make remainder as long as divisor.
for(// Normalise xd and yd so highest order digit of yd is >= base/2
(f=u/(C[0]+1)|0)>1&&(C=t(C,f,u),P=t(P,f,u),R=C.length,M=P.length),_=R,S=(b=P.slice(0,R)).length;S<R;)b[S++]=0;(D=C.slice()).unshift(0),A=C[0],C[1]>=u/2&&++A;do f=0,// Compare divisor and remainder.
(h=e(C,b,R,S))<0?(// Calculate trial digit, k.
E=b[0],R!=S&&(E=E*u+(b[1]||0)),// k will be how many times the divisor goes into the current remainder.
(f=E/A|0)>1?(f>=u&&(f=u-1),m=// product = divisor * trial digit.
(g=t(C,f,u)).length,S=b.length,1==// Compare product and remainder.
(h=e(g,b,m,S))&&(f--,// Subtract divisor from product.
i(g,R<m?D:C,m,u))):(0==f&&(h=f=1),g=C.slice()),(m=g.length)<S&&g.unshift(0),// Subtract product from remainder.
i(b,g,S,u),-1==h&&(S=b.length,// Compare divisor and new remainder.
(h=e(C,b,R,S))<1&&(f++,// Subtract divisor from remainder.
i(b,R<S?D:C,S,u))),S=b.length):0===h&&(f++,b=[0]),// Add the next digit, k, to the result array.
x[d++]=f,h&&b[0]?b[S++]=P[_]||0:(b=[P[_]],S=1);while((_++<M||void 0!==b[0])&&O--)v=void 0!==b[0]}x[0]||x.shift()}// logBase is 1 when divide is being used for base conversion.
if(1==p)w.e=l,n=v;else{// To calculate q.e, first get the number of digits of qd[0].
for(d=1,f=x[0];f>=10;f/=10)d++;w.e=d+l*p-1,T(w,c?s+w.e+1:s,a,v)}return w}}();/*
...
/*
   ...
   * arguments {number|string|Decimal}
   *
   */function tx(){return F(this,arguments,"gt")}/*
   ...
   * y {number|string|Decimal}
   *
   */function tb(t,e){return new this(t).mod(e)}/*
...
}if(0*t!=0){t||(this.s=NaN),this.e=NaN,this.d=null;return}return Y(this,t.toString())}if("string"!==r)throw Error(d+t);return 45===(i=t.charCodeAt(0))?(t=t.slice(1),this.s=-1):(43===i&&(t=t.slice(1)),this.s=1),b.test(t)?Y(this,t):/*
   * Parse the value of a new Decimal `x` from a string `str`, which is not a decimal value.
   */function(t,n){var i,r,o,s,a,c,u,l,f;if(n.indexOf("_")>-1){if(n=n.replace(/(\d)_(?=\d)/g,"$1"),b.test(n))return Y(t,n)}else if("Infinity"===n||"NaN"===n)return+n||(t.s=NaN),t.e=NaN,t.d=null,t;if(w.test(n))i=16,n=n.toLowerCase();else if(m.test(n))i=2;else if(x.test(n))i=8;else throw Error(d+n);// Remove trailing zeros.
 ...
 * @param data The data to pass into the event
 */function tf(t,e){var n="".concat(i.DoneInvoke,".").concat(t),r={type:n,data:e};return r.toString=function(){return n},r}function tp(t,e){var n="".concat(i.ErrorPlatform,".").concat(t),r={type:n,data:e};return r.toString=function(){return n},r}var tv=function(t){var e,n,i=[];try{for(var r=d(t),o=r.next();!o.done;o=r.next())for(var s=o.value,a=0;a<s.actions.length;){if(s.actions[a].type===b){i.push(s.actions[a]),s.actions.splice(a,1);continue}a++}}catch(t){e={error:t}}finally{try{o&&!o.done&&(n=r.return)&&n.call(r)}finally{if(e)throw e.error}}return i};function ty(t,e,n,o,s,a,c){void 0===c&&(c=!1);var u=c?[]:tv(s),l=u.length?$(n,o,u,e):n,v=c?[n]:void 0,w=[];return[q(s.map(function(s){var u,x,E=[];try{for(var O=d(s.actions),N=O.next();!N.done;N=O.next()){var _=N.value,M=function(s,u){var d;switch(u.type){case g:var x=function(t,e,n,i){var r,o={_event:n},s=tt(J(t.event)?t.event(e,n.data,o):t.event);if(Q(t.delay)){var a=i&&i[t.delay];r=J(a)?a(e,n.data,o):a}else r=J(t.delay)?t.delay(e,n.data,o):t.delay;return h(h({},t),{type:g,_event:s,delay:r})}(u,l,o,t.options.delays);return a&&"number"==typeof x.delay&&a(x,l,o),x;case m:var E=function(t,e,n,i){var r,o={_event:n},s=tt(J(t.event)?t.event(e,n.data,o):t.event);// TODO: helper function for resolving Expr
...
return a&&E.to!==r.Internal&&("entry"===s?w.push(E):a(E,l,o)),E;case S:var O,N=(O=l,h(h({},u),{value:Q(u.expr)?u.expr:u.expr(O,o.data,{_event:o})}));return null==a||a(N,l,o),N;case A:var _=null===(d=u.conds.find(function(n){var i=G(n.cond,t.options.guards);return!i||tn(t,i,l,o,a?void 0:e)}))||void 0===d?void 0:d.actions;if(!_)return[];var M=f(ty(t,e,l,o,[{type:s,actions:th(B(_),t.options.actions)}],a,c),2),T=M[0];return l=M[1],null==v||v.push(l),T;case R:var _=u.get(l,o.data);if(!_)return[];var D=f(ty(t,e,l,o,[{type:s,actions:th(B(_),t.options.actions)}],a,c),2),L=D[0];return l=D[1],null==v||v.push(l),L;case y:var k,P,N=(k=l,P=J(u.activity)?u.activity(k,o.data):u.activity,{type:i.Stop,activity:"string"==typeof P?{id:P}:P});return null==a||a(N,n,o),N;case b:l=$(l,o,[u],a?void 0:e),null==v||v.push(l);break;default:var C=tu(u,t.options.actions),I=C.exec;if(a)a(C,l,o);else if(I&&v){var j=v.length-1;C=h(h({},C),{exec:function(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n];I.apply(void 0,p([v[j]],f(e),!1))}})}return C}}(s.type,_);M&&(E=E.concat(M))}}catch(t){u={error:t}}finally{try{N&&!N.done&&(x=O.return)&&x.call(O)}finally{if(u)throw u.error}}return w.forEach(function(t){a(t,l,o)}),w.length=0,E})),l]}var tg=function(t){return"atomic"===t.type||"final"===t.type};function tm(t){return Object.keys(t.states).map(function(e){return t.states[e]})}function tw(t){return tm(t).filter(function(t){return"history"!==t.type})}function tx(t,e){var n,i,r,o,s,a,c,u,h=tb(new Set(t)),l=new Set(e);try{// add all ancestors
for(var f=d(l),p=f.next();!p.done;p=f.next())for(var v=p.value,y=v.parent;y&&!l.has(y);)l.add(y),y=y.parent}catch(t){n={error:t}}finally{try{p&&!p.done&&(i=f.return)&&i.call(f)}finally{if(n)throw n.error}}var g=tb(l);try{// add descendants
for(var m=d(l),w=m.next();!w.done;w=m.next()){var v=w.value;// if previously active, add existing child nodes
if("compound"!==v.type||g.get(v)&&g.get(v).length){if("parallel"===v.type)try{for(var x=(s=void 0,d(tw(v))),b=x.next();!b.done;b=x.next()){var S=b.value;l.has(S)||(l.add(S),h.get(S)?h.get(S).forEach(function(t){return l.add(t)}):S.initialStateNodes.forEach(function(t){return l.add(t)}))}}catch(t){s={error:t}}finally{try{b&&!b.done&&(a=x.return)&&a.call(x)}finally{if(s)throw s.error}}}else h.get(v)?h.get(v).forEach(function(t){return l.add(t)}):v.initialStateNodes.forEach(function(t){return l.add(t)})}}catch(t){r={error:t}}finally{try{w&&!w.done&&(o=m.return)&&o.call(m)}finally{if(r)throw r.error}}try{// add all ancestors
for(var E=d(l),O=E.next();!O.done;O=E.next())for(var v=O.value,y=v.parent;y&&!l.has(y);)l.add(y),y=y.parent}catch(t){c={error:t}}finally{try{O&&!O.done&&(u=E.return)&&u.call(E)}finally{if(c)throw c.error}}return l}function tb(t){var e,n,i=new Map;try{for(var r=d(t),o=r.next();!o.done;o=r.next()){var s=o.value;i.has(s)||i.set(s,[]),s.parent&&(i.has(s.parent)||i.set(s.parent,[]),i.get(s.parent).push(s))}}catch(t){e={error:t}}finally{try{o&&!o.done&&(n=r.return)&&n.call(r)}finally{if(e)throw e.error}}return i}function tS(t,e){return Array.isArray(t)?t.some(function(t){return t===e}):t instanceof Set&&t.has(e)}function tE(t,e){return"compound"===e.type?tw(e).some(function(e){return"final"===e.type&&tS(t,e)}):"parallel"===e.type&&tw(e).every(function(e){return tE(t,e)})}function tO(t){return new Set(q(t.map(function(t){return t.tags})))}var tN=/*#__PURE__*//** @class */function(){/**
...
var x=t.configuration.find(function(t){return"final"===t.type&&t.parent===h.machine}),b=x&&x.doneData?Y(x.doneData,t.context,e):void 0;this._doneEvent=tf(this.id,b);try{for(var S=d(this.doneListeners),E=S.next();!E.done;E=S.next()){var v=E.value;v(this._doneEvent)}}catch(t){c={error:t}}finally{try{E&&!E.done&&(u=S.return)&&u.call(S)}finally{if(c)throw c.error}}this._stop(),this._stopChildren(),tP.free(this.sessionId)}},/*
...
p(),this.stopListeners.delete(p)}}catch(t){n={error:t}}finally{try{y&&!y.done&&(i=v.return)&&i.call(v)}finally{if(n)throw n.error}}try{for(var g=d(this.contextListeners),m=g.next();!m.done;m=g.next()){var p=m.value;this.contextListeners.delete(p)}}catch(t){r={error:t}}finally{try{m&&!m.done&&(o=g.return)&&o.call(g)}finally{if(r)throw r.error}}try{for(var w=d(this.doneListeners),x=w.next();!x.done;x=w.next()){var p=x.value;this.doneListeners.delete(p)}}catch(t){a={error:t}}finally{try{x&&!x.done&&(c=w.return)&&c.call(w)}finally{if(a)throw a.error}}if(!this.initialized)return this;this.initialized=!1,this.status=s.Stopped,this._initialState=void 0;try{// we are going to stop within the current sync frame
// so we can safely just cancel this here as nothing async should be fired anyway
for(var b=d(Object.keys(this.delayedEventsMap)),S=b.next();!S.done;S=b.next()){var E=S.value;this.clock.clearTimeout(this.delayedEventsMap[E])}}catch(t){u={error:t}}finally{try{S&&!S.done&&(h=b.return)&&h.call(b)}finally{if(u)throw u.error}}// clear everything that might be enqueued
...
_sessionid:e?e._sessionid:null,historyValue:S?E?{current:S,states:function t(e,n){return j(e.states,function(e,i){if(e){var r=(Q(n)?void 0:n[i])||(e?e.current:void 0);if(r)return{current:r,states:t(e,r)}}})}(E,S)}:void 0:e?e.historyValue:void 0,history:!S||t.source?e:void 0,actions:S?V:[],activities:S?_:e?e.activities:{},events:[],configuration:w,transitions:t.transitions,children:q,done:b,tags:tO(w),machine:this}),Z=n!==I;B.changed=r.name===M||Z;var $=B.history;$&&delete $.history;// There are transient transitions if the machine is not in a final state
// and if some of the state nodes have transient ("always") transitions.
var z=!b&&(this._transient||g.some(function(t){return t._transient}));// If there are no enabled transitions, check if there are transient transitions.
...
if(!m&&(!z||""===r.name))return B;var H=B;if(!b)for(z&&(H=this.resolveRaisedTransition(H,{type:x},r,i));F.length;){var J=F.shift();H=this.resolveRaisedTransition(H,J._event,r,i)}// Detect if state changed
...
Display:     ${e.display}`);var n="";void 0!==e.firstOperand&&(n+=e.firstOperand.toSignificantDigits(15).toString()),void 0!==e.selectedOperator&&(n+=` ${c.toString(e.selectedOperator)}`),void 0!==e.secondOperand&&(n+=` ${e.secondOperand.toSignificantDigits(15).toString()}`),tH.innerText=n,tJ.innerText=e.display});!// Init
function(){document.querySelector(".calc").addEventListener("pointerdown",function(t){if("BUTTON"===t.target.tagName){var e;let n;(n=function(t){switch(!0){case c.isNumber(t):return"NUMBER";case c.isOperator(t):return"OPERATOR";case c.EQUALS==t:return"EQUALS";case c.BACKSPACE==t:return"DELETE";case c.DECIMAL==t:return"DECIMAL";case c.SIGN==t:return"SIGN";case c.CLEAR==t:return"CLEAR";case c.MEMORY_CLEAR==t:return"MEMORY_CLEAR";case c.MEMORY_RECALL==t:return"MEMORY_RECALL";case c.MEMORY_PLUS==t:return"MEMORY_PLUS";case c.MEMORY_MINUS==t:return"MEMORY_MINUS";default:return}}(e=t.target.value))?tQ.send({type:n,value:e}):alert(`Error: button value "${e}" is not valid.`),// Change color on click
t.target.classList.add("btn-active")}});let t=t=>{"BUTTON"===t.target.tagName&&t.target.classList.remove("btn-active")};document.querySelector(".calc").addEventListener("pointerup",t),document.querySelectorAll(".btn").forEach(e=>e.addEventListener("pointerleave",t)),document.querySelector("#dark-mode-toggle").addEventListener("pointerdown",function(){document.querySelector("#container").classList.toggle("dark-mode")}),// Set options for Decimal.js
(0,u.Decimal).set({toExpPos:15,toExpNeg:-14,precision:20}),tQ.start()}();//# sourceMappingURL=index.cd13657a.js.map

//# sourceMappingURL=index.cd13657a.js.map
